...
export const ApiBanner = () => {
  return (
    <section
      id="api-banner-section"
      className="bg-[#ecfeff] border-y border-dotted border-[#10b981] px-4 md:px-10 py-12 md:py-16"
    >
      <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div className="flex-1">
          ...
          <p className="text-base md:text-lg text-slate-600 max-w-2xl leading-relaxed">
            Acesse currículos parseados e dados estruturais de grupos de
            pesquisa diretamente através da nossa interface programática.
            Projetado para pesquisadores, instituições e cientistas de dados.
          </p>
        </div>
